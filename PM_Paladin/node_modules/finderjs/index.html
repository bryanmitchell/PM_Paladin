...
<body class="site">
  ...
  <header class="header">
    ...
    <h2 class="sub-title">Finder-like UI component for viewing hierarchical content in columns</h2>
  ...
  <main class="site-content">
    <section>
      ...
      <p><strong>Finder</strong>JS allows you to browse hierarchical data in columns, similar to OS X's <a href="https://en.wikipedia.org/wiki/Finder_(software)">Finder<span class="fa fa-external-link"></span></a>.</p>
      <h3>Features</h3>
      <ul>
        <li><strong>Data source:</strong> Array or Function (useful for dynamic/asynchronous content such as a remote web service).</li>
        <li><strong>Rendering:</strong> define how items are rendered.</li>
        <li><strong>Stlying:</strong> Use any CSS/framework of choice, or feel free to use the example CSS (which leverages <a href="http://www.w3.org/TR/css-flexbox-1/">Flexbox<span class="fa fa-external-link"></span></a>). Additionally, classnames are customizable.</li>
        ...
        <li><strong>Module formats:</strong> Provided as an npm module (CommonJS), a jQuery plugin, and exported as the global <em>finderjs</em>.</li>
        <li><strong>File size:</strong> 4KB minified and gzipped.</li>
    ...
    <section class="example">
      ...
      <p><strong>Note</strong>: these examples require CSS flexbox support.</p>
...
.on('leaf-selected', function(item) {
  ...
  <footer class="footer">
    ...
    <p>Created by <a href="http://twitter.com/brazill">Mark Matyas</a>. Source code released under the <a href="https://raw.githubusercontent.com/mynameistechno/finderjs/master/LICENSE">MIT license</a>.</p>
